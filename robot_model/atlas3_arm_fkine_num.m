% Calculate Forward Kinematics for Atlas Robot (v3)
% 
% Input:
% q [1x6]
%   Joint Angles [rad]
...
function T_c_urdf = atlas3_arm_fkine_num(q, lr)
%% Init
%#codegen
% Coder Information
...
p_num = atlas3_arm_parameter_urdf(lr);
...
% 1     shy: utorso -> clav
T_urdf(:,:,1) = transl(p_num(1:3)) * angvec2tr(q(1), [0, p_num(4:5)]);
