% Convert dynamic parameters from urdf to mdh for atlas v3 leg
% 
% Input:
% lr [1x1 logical]
...
function [rSges_num_mdh, Iges_num_mdh] = atlas3_leg_convert_urdf_mdh(lr, rSges_num_urdf, Iges_num_urdf)
